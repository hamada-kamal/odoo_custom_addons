...
class CostType(models.Model):
    ...
    def set_confirm(self):
        ...
        if self.medical:
            ...
            self.monthly_cost = 200
        elif self.visa:
            self.monthly_cost = 300
    ...
    @staticmethod
    def is_employee_assign_date_matches(assign_date,day):
        return assign_date.day <= day
    ...
    def _cron_create_employee(self):
        ...
        if self.is_today_target_day(visa_type.date_from):
            ...
            for emp in employees:
                if self.is_employee_assign_date_matches(emp.assign_date, visa_type.day):
                    self.create_employee_cost_record(emp, visa_type)
